...
| Star Contender | 球星挑战赛 |
| Youth Star Contender | 青少年球星挑战赛 |
| Contender | 挑战赛 |
| Youth Contender | 青少年挑战赛 |
| Feeder | 支线赛 |
| Finals | 总决赛 |
| Championships | 锦标赛 |
| Cup | 杯赛 |
...
### 4. 地点后缀
- WTT比赛所有城市地点名称后加"站"：`多哈站`、`北京站`、`曼谷站`
- 多城市赛事保留连接符：`爱知·名古屋`
- 运动会保留全称：`亚洲运动会`、`青年奥林匹克运动会`

### 5. 序号/届数
- 罗马数字紧跟地名后：`旧金山站II`、`伊斯坦布尔站II`
- 阿拉伯数字届数保留原词：`第二十五届中美洲和加勒比地区运动会`

### 6. 特殊赛事
| 类型 | 翻译示例 |
|------|----------|
| Para（残障） | 世界残疾人乒乓球[类型]赛 |
| Youth | 青少年 |
| U21/U13 | U21/U13 |
| Team | 团体 |
| Mixed Team | 混合团体 |
