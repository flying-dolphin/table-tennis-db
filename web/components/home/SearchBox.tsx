  ...
  return (
    <div className="relative -mt-6 px-6 z-20">
      <button
        ...
        aria-label="登录后使用搜索"
      >
        <div className="flex items-center bg-white rounded-2xl h-14 px-5 gap-3 shadow-md border border-slate-100 transition-all duration-300 group-hover:shadow-lg">
        ...
        <input
          ...
          readOnly
        />
        <span className="text-[11px] font-medium text-text-tertiary">登录后可用</span>
      </div>
      </button>
    </div>
  );
