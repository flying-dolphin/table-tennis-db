#!/usr/bin/env python3
"""
Translate ranking files from orig to cn.
"""
...
CHECKPOINT_PATH = PROJECT_ROOT / "data" / "rankings" / "checkpoint_translate_rankings.json"


def _translate_ck(filename: str) -> str:
    return f"rankings|file:{filename}|translate"
...
def translate_ranking_data(data: dict, translator: Translator) -> dict:
    ...
    if not isinstance(translated, dict):
        raise TypeError("ranking data must be a dict")
    return translated
